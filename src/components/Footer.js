  ...
  return (
    <div className='FooterContainer'>
        <div className='imageFooterContainer'>
            <img className='FooterImage' src='EventLogo.png'/>
        </div>

        <div className='getIntouchContainer'>
            <h2>Get In Touch</h2>
            <div class="icons">
              <h6><CiLocationOn/> 123 sagar haveli new delhi,235901</h6>
              <h6><MdEmail/> eventifyorg4455@gmail.com</h6>
              <h6>
                 <FaPhoneAlt/> +91-7865904431
              </h6>

              <h6><FaCircleInfo/> 24/7</h6>
          </div>
        </div>
        <div className='socialAccContainer'>
            <h1 className='socialAcc'>Social Accounts</h1>
            <div>
            <ul class="example-2">
